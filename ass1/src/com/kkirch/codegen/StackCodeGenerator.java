 ...
 * @author kkirch
 */
public class StackCodeGenerator implements ICodeGenerator {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (matcher.matches()) {
                    ...
                    if (matcher.group(2) != null) {
                        ...
                        emitString("POP " + matcher.group(1) + "(" + offset + ")", outStream);
                    } else {
                        emitString("POP " + matcher.group(1), outStream);
                    }
                    continue;
                }
                ...
                if (matcher.matches()) {
                    ...
                    if (matcher.group(4) != null) {
                        ...
                        emitString("PUSH " + matcher.group(3) + "(" + offset + ")", outStream);
                    } else {
                        emitString("PUSH " + matcher.group(3), outStream);
                    }
                ...
                if (matcher.matches()) {
                    ...
                    if (matcher.group(6) != null) {
                        ...
                        emitString("PUSH " + matcher.group(5) + "(" + offset + ")", outStream);
                    } else {
                        emitString("PUSH " + matcher.group(5), outStream);
                    }

                    emitString(op, outStream);
                ...
                if (matcher.matches()) {
                    ...
                    emitString("PUSH " + "#" + matcher.group(6), outStream);
                ...
                if (matcher.matches()) {
                    ...
                    if (matcher.group(7) != null) {
                        ...
                        emitString("PUSH " + matcher.group(6) + "(" + offset + ")", outStream);
                    } else {
                        emitString("PUSH " + matcher.group(6), outStream);
                    }
